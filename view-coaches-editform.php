    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="cTeam<?php echo $coach['coach_id']; ?>" class="form-label">Coach Team</label>
            <input type="text" class="form-control" id="cTeam<?php echo $coach['coach_id']; ?>" name = "cTeam" value="<?php echo $coach['coach_team']; ?>">
          </div>
